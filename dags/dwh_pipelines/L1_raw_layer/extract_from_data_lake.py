...
def get_data_raw_from_dl() -> None:
    """Retrieve data from dl into local"""
    root_logger.info("Beginning get_data_raw_from_dl... ")
    client = boto3.client("s3")
    file_names, folders = get_file_folders(client, "confidential")
    download_files(
        client,
        "confidential",
        "/opt/airflow/dags/dwh_pipelines/L1_raw_layer/data_from_dl",
        file_names,
        folders,
    )
    root_logger.info("Ending get_data_raw_from_dl... ")
