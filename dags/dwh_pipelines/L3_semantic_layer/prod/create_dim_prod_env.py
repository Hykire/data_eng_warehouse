...
def main_dwh_l3_prod() -> None:
    """main process to create dwh l3 prod environment"""
    root_logger.info("Beginning main_dwh_l3_prod process...")
    __create_infra()
    root_logger.info("Ending main_dwh_l3_prod process...")
