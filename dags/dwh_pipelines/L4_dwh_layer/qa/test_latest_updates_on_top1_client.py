...
@dag(
    dag_id="dwh_pipelines.L4_dwh_layer.user_access_layer.latest_updates_on_top1_client",
    default_args=default_args,
    start_date=datetime(2023, 8, 16, 20, 0, 0),
    schedule_interval="@hourly",
)
def perform_test() -> None:
    """unit test for perform_create_view_latest_updates_on_top1_client"""

    @task()
    def perform_main() -> None:
        module_name = (
            "dwh_pipelines.L4_dwh_layer.user_access_layer.latest_updates_on_top1_client"
        )
